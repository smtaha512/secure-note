...
import { FetchSecureNoteRequestParamsDto } from './fetch-secure-note.request.params.dto';

const isNotEmpty = 'id should not be empty';
const isUuid = 'id must be a UUID';

describe('FetchSecureNoteRequestParamsDto', () => {
  describe('success scenarios', () => {
    it('should not have error if id is a valid uuid', async () => {
      const params = new FetchSecureNoteRequestParamsDto();
      params.id = uuidV4();
